...
const Profile = () => {
  const [user, setUser] = useState({ name: 'John Doe', avatar: '/default-avatar.png' });
  const [newName, setNewName] = useState('');
  const [newAvatar, setNewAvatar] = useState('');
  const [loading, setLoading] = useState(false);

  // Simulate fetching user profile data on page load
  useEffect(() => {
  ...
  const handleUpdateProfile = (e) => {
    ...
    // Simulate form submission and profile update
    setTimeout(() => {
      setUser({
